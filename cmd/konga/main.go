...
import (
	...
	"gitlab.com/hyperd/konga-backend/cockroachdb"
	kongasvc "gitlab.com/hyperd/konga-backend/implementation"
	"gitlab.com/hyperd/konga-backend/inmemory"
	"gitlab.com/hyperd/konga-backend/middleware"
	httptransport "gitlab.com/hyperd/konga-backend/transport/http"
...
func main() {
	...
	var svc konga.Service
	{
		if isInMemory {
			...
			svc = kongasvc.NewService(repository, logger)
		} else {
